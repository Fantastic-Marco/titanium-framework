...
public class EncryptQueryInterceptor extends EncryptionBaseInterceptor implements Interceptor {
    ...
    public EncryptQueryInterceptor(EncryptProperties encryptProperties, IEncryptor encryptor) {
        super(encryptProperties,encryptor);
    }
    ...
    private List<String> getEncryptParamByMethod(MappedStatement mappedStatement) {
        ...
        if (CollUtil.isEmpty(list)) {
            ...
            for (Parameter p : method.getParameters()) {
                if (p.isAnnotationPresent(Encrypt.class) && p.getType() == String.class) {
    ...
    private List<String> getEntityEncryptFields(Class clazz) {
        ...
        return Arrays.stream(fields)
                .filter(EncryptQueryInterceptor::isEncryptField)
                .map(e -> {
